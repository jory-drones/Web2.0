    ...
    <section className="py-20 px-6 md:px-16 flex flex-col md:flex-row items-center justify-between gap-12">
      ...
      <div className="w-full md:w-1/2 text-center md:text-left">
        ...
        <p className="text-gray-300 mb-4">
          Brains. Charging. Control. The Hive is more than just a charging station — it’s
          the command center of the system, processing and analyzing data with embedded
          AI computing. It securely houses and recharges The Bee, ensuring continuous
